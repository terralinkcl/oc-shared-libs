...
${item.comentario}` : ""
    ...
    /* @__PURE__ */ jsxs(View, { style: s.footerRow, children: [
      ...
      /* @__PURE__ */ jsxs(View, { style: s.totalsBox, children: [
        ...
        /* @__PURE__ */ jsxs(View, { style: s.totalRow, children: [
          /* @__PURE__ */ jsx(Text, { style: s.totalLabel, children: "Neto Afecto:" }),
          /* @__PURE__ */ jsx(Text, { style: s.totalValue, children: fmt(netoAfecto, moneda) })
        ] }),
        /* @__PURE__ */ jsxs(View, { style: s.totalRow, children: [
          /* @__PURE__ */ jsx(Text, { style: s.totalLabel, children: "Exento:" }),
          /* @__PURE__ */ jsx(Text, { style: s.totalValue, children: fmt(netoExento, moneda) })
        ] }),
        ...
        imptoEspecifico > 0 && /* @__PURE__ */ jsxs(View, { style: s.totalRow, children: [
          /* @__PURE__ */ jsx(Text, { style: s.totalLabel, children: "Impto. especifico (cod. 28):" }),
          /* @__PURE__ */ jsx(Text, { style: s.totalValue, children: fmt(imptoEspecifico, moneda) })
        ] }),
