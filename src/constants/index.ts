...
export const AGRUPACION_OPTIONS: { value: AgrupacionOC; label: string; area: string }[] = [
  ...
  { value: "protocolos_conexion",    label: "Protocolos de conexión",  area: "Gastos Op. y Admin" },
  { value: "solicitud_conexion",     label: "Solicitud de conexión",   area: "Gastos Op. y Admin" },
  ...
  { value: "telefonia_movil",        label: "Telefonía móvil",         area: "Gastos Op. y Admin" },
  { value: "cafeteria_agua_filtrada",label: "Cafetería (agua filtrada)", area: "Gastos Op. y Admin" },
